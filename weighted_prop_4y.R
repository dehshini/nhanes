...
prop_highsrh_gt65.2 <- do.call(
    rbind, lapply(lowsrh_gt65.2, calculate_svy_prop, "high_srh")
)
# add a column for age group
prop_highsrh_gt65.2$Age <- ">=65"
write.csv(prop_highsrh_gt65.2, file = "./out/highsrh_gt65_2.csv")


prop_highsrh_lt65.2 <- do.call(
    rbind, lapply(lowsrh_lt65.2, calculate_svy_prop, "high_srh")
)
# add a column for age group
prop_highsrh_lt65.2$Age <- "<65"
write.csv(prop_highsrh_lt65.2, file = "./out/highsrh_lt65_2.csv")


####################
# by SEX, male and female
####################
prop_highsrh_male.2 <- do.call(
    rbind, lapply(lowsrh_male.2, calculate_svy_prop, "high_srh")
)
# add a column for sex
prop_highsrh_male.2$Sex <- "Male"
write.csv(prop_highsrh_male.2, file = "./out/highsrh_male_2.csv")


prop_highsrh_female.2 <- do.call(
    rbind, lapply(lowsrh_female.2, calculate_svy_prop, "high_srh")
)
# add a column for sex
prop_highsrh_female.2$Sex <- "Female"
write.csv(prop_highsrh_female.2, file = "./out/highsrh_female_2.csv")
...
lowsrh_white.2 <- lapply(weighted_4y_list, subset, RACE == 1)
# calculate the proportion of low_srh
prop_highsrh_white.2 <- do.call(
    rbind, lapply(lowsrh_white.2, calculate_svy_prop, "high_srh")
)
# add a column for ethnicity
prop_highsrh_white.2$Ethnicity <- "White"
write.csv(prop_highsrh_white.2, file = "./out/highsrh_white_2.csv")

lowsrh_black.2 <- lapply(weighted_4y_list, subset, RACE == 2)
# calculate the proportion of low_srh
prop_highsrh_black.2 <- do.call(
    rbind, lapply(lowsrh_black.2, calculate_svy_prop, "high_srh")
)
# add a column for ethnicity
prop_highsrh_black.2$Ethnicity <- "Black"
write.csv(prop_highsrh_black.2, file = "./out/highsrh_black_2.csv")


lowsrh_hispanic.2 <- lapply(weighted_4y_list, subset, RACE == 3)
# calculate the proportion of low_srh
prop_highsrh_hispanic.2 <- do.call(
    rbind, lapply(lowsrh_hispanic.2, calculate_svy_prop, "high_srh")
)
# add a column for ethnicity
prop_highsrh_hispanic.2$Ethnicity <- "Hispanic"
write.csv(prop_highsrh_hispanic.2, file = "./out/highsrh_hispanic_2.csv")


lowsrh_other.2 <- lapply(weighted_4y_list, subset, RACE == 4)
# calculate the proportion of high_srh
prop_highsrh_other.2 <- do.call(
    rbind, lapply(lowsrh_other.2, calculate_svy_prop, "high_srh")
)
# add a column for ethnicity
prop_highsrh_other.2$Ethnicity <- "Other"
write.csv(prop_highsrh_other.2, file = "./out/highsrh_other_2.csv")
...
lowsrh_poverty.2 <- lapply(weighted_4y_list, subset, INDFMPIR < 1)
# calculate the proportion of high_srh
prop_highsrh_poverty.2 <- do.call(
    rbind, lapply(lowsrh_poverty.2, calculate_svy_prop, "high_srh")
)
# add a column for income
prop_highsrh_poverty.2$Income <- "Below poverty threshold"
write.csv(prop_highsrh_poverty.2, file = "./out/highsrh_poverty_2.csv")

lowsrh_no_poverty.2 <- lapply(weighted_4y_list, subset, INDFMPIR >= 1)
# calculate the proportion of high_srh
prop_highsrh_no_poverty.2 <- do.call(
    rbind, lapply(lowsrh_no_poverty.2, calculate_svy_prop, "high_srh")
)
# add a column for income
prop_highsrh_no_poverty.2$Income <- "Above poverty threshold"
write.csv(prop_highsrh_no_poverty.2, file = "./out/highsrh_no_poverty_2.csv")
...
# calculate the proportion of high_srh
prop_highsrh_insured.2 <- do.call(
    rbind, lapply(lowsrh_insured.2, calculate_svy_prop, "high_srh")
)
# add a column for insurance
prop_highsrh_insured.2$Insurance <- "Insured"
write.csv(prop_highsrh_insured.2, file = "./out/highsrh_insured_2.csv")

lowsrh_uninsured.2 <- lapply(
    weighted_4y_list, subset, insurance == 1 | insurance == 2
)
# calculate the proportion of high_srh
prop_highsrh_uninsured.2 <- do.call(
    rbind, lapply(lowsrh_uninsured.2, calculate_svy_prop, "high_srh")
)
# add a column for insurance
prop_highsrh_uninsured.2$Insurance <- "Uninsured"
write.csv(prop_highsrh_uninsured.2, file = "./out/highsrh_uninsured_2.csv")
...
lowsrh_belowhighschool.2 <- lapply(weighted_4y_list, subset, EDULEVEL == 1)
# calculate the proportion of low_srh
prop_highsrh_belowhighschool.2 <- do.call(
    rbind, lapply(lowsrh_belowhighschool.2, calculate_svy_prop, "high_srh")
)
# add a column for education
prop_highsrh_belowhighschool.2$Education <- "Below high school"
write.csv(prop_highsrh_belowhighschool.2, file = "./out/highsrh_belowhighschool_2.csv")

lowsrh_highschool.2 <- lapply(weighted_4y_list, subset, EDULEVEL == 2)
# calculate the proportion of high_srh
prop_highsrh_highschool.2 <- do.call(
    rbind, lapply(lowsrh_highschool.2, calculate_svy_prop, "high_srh")
)
# add a column for education
prop_highsrh_highschool.2$Education <- "High school"
write.csv(prop_highsrh_highschool.2, file = "./out/highsrh_highschool_2.csv")

lowsrh_college.2 <- lapply(weighted_4y_list, subset, EDULEVEL == 3)
# calculate the proportion of high_srh
prop_highsrh_college.2 <- do.call(
    rbind, lapply(lowsrh_college.2, calculate_svy_prop, "high_srh")
)
# add a column for education
prop_highsrh_college.2$Education <- "College"
write.csv(prop_highsrh_college.2, file = "./out/highsrh_college_2.csv")
...
lowsrh_lt7.2 <- lapply(weighted_4y_list, subset, HBA1C < 7)
# calculate the proportion of high_srh
prop_highsrh_lt7.2 <- do.call(
    rbind, lapply(lowsrh_lt7.2, calculate_svy_prop, "high_srh")
)
# add a column for HBA1C
prop_highsrh_lt7.2$HBA1C <- "<7"
write.csv(prop_highsrh_lt7.2, file = "./out/highsrh_lt7_2.csv")

lowsrh_7to9.2 <- lapply(weighted_4y_list, subset, HBA1C >= 7 & HBA1C <= 9)
# calculate the proportion of high_srh
prop_highsrh_7to9.2 <- do.call(
    rbind, lapply(lowsrh_7to9.2, calculate_svy_prop, "high_srh")
)
# add a column for HBA1C
prop_highsrh_7to9.2$HBA1C <- "7-9"
write.csv(prop_highsrh_7to9.2, file = "./out/highsrh_7to9_2.csv")

lowsrh_gt9.2 <- lapply(weighted_4y_list, subset, HBA1C > 9)
# calculate the proportion of high_srh
prop_highsrh_gt9.2 <- do.call(
    rbind, lapply(lowsrh_gt9.2, calculate_svy_prop, "high_srh")
)
# add a column for HBA1C
prop_highsrh_gt9.2$HBA1C <- ">9"
write.csv(prop_highsrh_gt9.2, file = "./out/highsrh_gt9_2.csv")
